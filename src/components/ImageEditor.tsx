		...
		<div className='fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center'>
			<div className='bg-black rounded-xl p-12 flex flex-col gap-4'>
				...
				<div className='flex items-center justify-between'>
					...
					<button className='py-2 px-4 bg-white text-black font-bold rounded-full' onClick={onClose}>Save</button>
				</div>
				{/* IMAGE */}
				...
				<div className='flex items-center justify-between text-sm'>
					...
					<div
						className={`cursor-pointer py-2 px-4 rounded-full font-semibold text-black ${settings.sensitive ? 'bg-red-500' : 'bg-white'}`}
